...
class ObjectType extends Type {
    ...
    extend(shape) {
        return new ObjectType(Object.assign(Object.assign({}, this.shape), shape), this._restType);
    }
    pick(...keys) {
        const shape = {};
...
function createObjectMatcher(shape, rest, checks) {
    ...
    const fastPath = indexedEntries.length === 0 &&
        (rest === null || rest === void 0 ? void 0 : rest.name) === "unknown" &&
        checks === undefined;
    return (obj, flags) => {
        if (fastPath) {
            return undefined;
...
function createObjectKeyMatcher(objects, key) {
    ...
    return (obj, flags) => {
        ...
        const option = (_a = byType === null || byType === void 0 ? void 0 : byType[toInputType(value)]) !== null && _a !== void 0 ? _a : byLiteral === null || byLiteral === void 0 ? void 0 : byLiteral.get(value);
...
function createUnionBaseMatcher(terminals) {
    ...
    return (value, flags) => {
        ...
        const options = flags & FLAG_MISSING_VALUE
            ? optionalMatchers
            : ((_b = (_a = byType === null || byType === void 0 ? void 0 : byType[toInputType(value)]) !== null && _a !== void 0 ? _a : byLiteral === null || byLiteral === void 0 ? void 0 : byLiteral.get(value)) !== null && _b !== void 0 ? _b : unknownMatchers);
        let count = 0;
        let issueTree = issue;
 ...
 */
export const unknown = /*#__PURE__*/ singleton("unknown", TAG_UNKNOWN, () => undefined);
/**
 * Create a validator that never matches any value,
 * analogous to the TypeScript type `never`.
 */
export const never = /*#__PURE__*/ singleton("never", TAG_NEVER, () => ISSUE_EXPECTED_NOTHING);
/**
 * Create a validator that matches any string value.
 */
export const string = /*#__PURE__*/ singleton("string", TAG_STRING, (v) => (typeof v === "string" ? undefined : ISSUE_EXPECTED_STRING));
/**
 * Create a validator that matches any number value.
 */
export const number = /*#__PURE__*/ singleton("number", TAG_NUMBER, (v) => (typeof v === "number" ? undefined : ISSUE_EXPECTED_NUMBER));
/**
 * Create a validator that matches any bigint value.
 */
export const bigint = /*#__PURE__*/ singleton("bigint", TAG_BIGINT, (v) => (typeof v === "bigint" ? undefined : ISSUE_EXPECTED_BIGINT));
/**
 * Create a validator that matches any boolean value.
 */
export const boolean = /*#__PURE__*/ singleton("boolean", TAG_BOOLEAN, (v) => (typeof v === "boolean" ? undefined : ISSUE_EXPECTED_BOOLEAN));
/**
