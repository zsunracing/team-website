...
const record = (valueType) => {
    return /*#__PURE__*/ new ObjectType({}, valueType !== null && valueType !== void 0 ? valueType : (0, exports.unknown)());
};
 ...
 */
const array = (item) => {
    return /*#__PURE__*/ new ArrayOrTupleType([], item !== null && item !== void 0 ? item : (0, exports.unknown)(), []);
};
exports.array = array;
/**
